          ...
          <div className="space-y-4 mb-8">
            {secretaryOptions.map((option) => (
              <Button
                ...
                disabled={isLoading}
                className="w-full h-16 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white border-0 rounded-xl shadow-lg transition-all duration-200 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
              >
