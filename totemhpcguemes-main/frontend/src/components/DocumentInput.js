  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8" style={{
      ...
      <Card className="w-full max-w-2xl shadow-2xl border-0 bg-white">
        ...
        <CardContent className="p-4 sm:p-8 rounded-b-lg" style={{
          background: '#4A90E2'
        }}>
          {/* Título */}
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-white text-base sm:text-lg mt-2 font-bold">
          ...
          <div className="mb-6 sm:mb-8">
            <div className="border-2 border-gray-300 rounded-lg p-4 text-center" style={{
              ...
              <div className="text-2xl sm:text-3xl font-mono text-white min-h-[40px] flex items-center justify-center">
                {document || ''}
              </div>
            </div>
          </div>
            ...
            {keypadNumbers.map((row, rowIndex) => 
              row.map((num, colIndex) => {
                if (num === '') {
                    ...
                    if (colIndex === 0) {
                      return (
                        <Button
                          ...
                          className="h-12 sm:h-16 w-full text-sm sm:text-lg font-bold bg-orange-400 hover:bg-orange-500 text-white border-2 border-orange-500"
                      ...
                      return (
                        <Button
                          ...
                          className="h-12 sm:h-16 w-full text-sm sm:text-lg font-bold bg-green-500 hover:bg-green-600 text-white border-2 border-green-600"
                          disabled={isLoading || !document}
                        >
                          ACEPTAR
                        </Button>
                  ...
                  return <div key={`empty-${rowIndex}-${colIndex}`} className="h-12 sm:h-16"></div>;
                }
                ...
                return (
                  <Button
                    ...
                    className="h-12 sm:h-16 w-full text-xl sm:text-2xl font-bold bg-gray-200 hover:bg-gray-300 text-gray-800 border-2 border-gray-400 transition-all duration-150 active:bg-gray-400"
                    disabled={isLoading}
                  >
                    {num}
                  </Button>
