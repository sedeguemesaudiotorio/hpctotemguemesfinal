        ...
        <CardContent className="bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 p-12 rounded-b-lg">
          ...
          <div className="space-y-6 max-w-lg mx-auto">
            <Button
              ...
              className="w-full h-20 text-xl font-semibold text-white border-2 transition-all duration-300 transform hover:scale-105"
              style={{backgroundColor: '#0098a3', borderColor: '#0098a3'}}
              onMouseEnter={(e) => e.target.style.backgroundColor = '#007580'}
              onMouseLeave={(e) => e.target.style.backgroundColor = '#0098a3'}
            >
              Ya Tengo Turno
            </Button>
            ...
            <Button
              ...
              className="w-full h-20 text-xl font-semibold text-white border-2 transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
              style={{backgroundColor: '#0098a3', borderColor: '#0098a3'}}
              onMouseEnter={(e) => e.target.style.backgroundColor = '#007580'}
              onMouseLeave={(e) => e.target.style.backgroundColor = '#0098a3'}
            >
